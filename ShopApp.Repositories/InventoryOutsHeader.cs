...
namespace ShopApp.Repositories
{
    public class InventoryOutsHeadersRepository : DataLayer.GenericRepository<Entities.InventoryOutsHeader>,RepositoryAbstracts.IInventoryOutsHeadersRepository
    {
        ...
        public List<Entities.InventoryOutsHeader> GetByAcceptDate(DateTime? value)
        {
            return RunQuery("SELECT * FROM[dbo].[InventoryOutsHeaders] WHERE [AcceptDate] = @Value", new SqlParameter("Value", value));
        }
        public List<Entities.InventoryOutsHeader> GetByAcceptedByUserId(int? value)
        {
        ...
        public List<Entities.InventoryOutsHeader> GetByDeletedByUserId(int? value)
        {
