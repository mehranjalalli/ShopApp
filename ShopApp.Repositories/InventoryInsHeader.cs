...
namespace ShopApp.Repositories
{
    public class InventoryInsHeadersRepository : DataLayer.GenericRepository<Entities.InventoryInsHeader>,RepositoryAbstracts.IInventoryInsHeadersRepository
    {
        ...
        public List<Entities.InventoryInsHeader> GetByAcceptDate(DateTime? value)
        {
            return RunQuery("SELECT * FROM[dbo].[InventoryInsHeaders] WHERE [AcceptDate] = @Value", new SqlParameter("Value", value));
        }
